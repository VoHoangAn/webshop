...
public class FileStorageImpl implements FileStorageService {
    ...
    public void save(MultipartFile file) {
        try {
            logger.error(this.root.toAbsolutePath().toString());
            long f = Files.copy(file.getInputStream(), this.root.resolve(file.getOriginalFilename()));
            logger.error("IMG WORKING"+this.root);
        } catch (Exception e) {
