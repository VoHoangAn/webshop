...
public class JwtService {
    ...
    private static final String SECRET_KEY = "4428472B4B6250655368566D597133743677397A244326452948404D63516654";
    ...
    public boolean isTokenValid(String token, UserDetails userDetails) {
        ...
        return username.equals(userDetails.getUsername()) && !isTokenExpired(token) && !jwtToken.isRevoked();
    }
